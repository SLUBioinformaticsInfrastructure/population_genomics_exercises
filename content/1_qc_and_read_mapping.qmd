...
## Description of what is in the folder 1_read_mapping
1. The reference sequence: lentinula_scaffold_1.fa
2. Forward and reverse reads for 20 simulated individuals SE001 to SE020 in a separate folder (fastq)
...
To trim poor quality sequences, consider Trimmomatic (http://www.usadellab.org/cms/?page=trimmomatic) or scripts within the BBMap package (https://github.com/BioInfoTools/BBMap). We won't be touching on trimming and repairing mismatched reads in this tutorial.
